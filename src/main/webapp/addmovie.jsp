  ...
  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;
		...
		<form class="form-horizontal" action="Addmovie" method="post">
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="number" class="form-control" name="movieid"
						placeholder="Enter MovieId">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="Movie Name">Movie
					Name</label>
				<div class="col-md-5">
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="Cover URL"> Cover
					URL</label>
				<div class="col-md-5">
