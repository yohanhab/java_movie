...
<!-- AddThis Smart Layers END -->
	<div class="m-tickets-instantly">
		...
		<div class="m-select-movies">
					<select class="list_of_movies"><option value="">Select Theater</option>
					<%
		...
		<div class="m-select-movies">
					<select class="list_of_movies"><option value="">Select Time</option></select>
		</div>
		<div class="col-md-5">
					<input type="text" class="list_of_movies" name="no of seats" placeholder="Enter No of Seats">
				</div>
			
		<div class="m-select-movies">
					<select class="list_of_movies"><option value="">Seat Type</option></select>
		</div>
		<div class="m-select-movies">
					<input type="submit" class="list_of_movies" value="Proceed to Payment">
		</div>
		<div class="clearfix"></div>
	</div>
