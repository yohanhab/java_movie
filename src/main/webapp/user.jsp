...
function fun() {
	...
	if(window.XMLHttpRequest)
		...
		obj.open("GET",urls,true);
		obj.send();
		obj.onreadystatechange=function()
		{
			if(obj.readyState==4 && obj.status==200)	
			document.getElementById("movie").innerHTML=obj.responseText; 
		}
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="user.jsp">Ticket</a></li>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="main-banner">
		 ...
		 <form class="form-horizontal"  action="ticket.jsp" method="post">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
                    ...
                    <select class="list_of_movies" onchange="fun()" id="city">
        	...
        	Connection con=Provider.getConnection();
    		  ...
    		  <%}rs.close();stmt.close(); %>
				...
				<%-- <select class="list_of_movies"><option value="">Select Movie</option>
					<%
			...
			<div>
				<input type="date" style="margin-top:5px; width:350px" class="form-control" name="date"/>
			</div>
			<div>
			<input type="submit" style="margin-top:5px; width:350px" class="btn btn-primary" value="GO">
			</div>
